...
The revised controller on the [`v4-stage12-inmemory-handoff-e9` source branch](https://github.com/agnidasgupta/Pole_Line_3D_Recon/blob/v4-stage12-inmemory-handoff-e9/ops/v4_stage12_inmemory_handoff_e9/run_e9_stage12_handoff.sh) uses **CUDA Graph off and `RESUME=0` for both
