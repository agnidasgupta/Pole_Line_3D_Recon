#!/usr/bin/env python3
"""Deterministic scheduler and CUDA patch-value regression tests for opt1."""
...
from v4_realtime_core_opt import (
...
def main():
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for the Stage1 opt1 self-test")
    ...
    print("V4_STAGE1_OPT1_SELF_TEST_OK")
