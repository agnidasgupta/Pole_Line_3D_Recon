#!/usr/bin/env python3
"""Compatibility entry point; implementation: src/poleline/stage1/kernels/groupnorm_layout.py."""
...
_execute(globals(), 'src/poleline/stage1/kernels/groupnorm_layout.py')
