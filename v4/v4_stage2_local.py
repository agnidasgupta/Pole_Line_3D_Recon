#!/usr/bin/env python3
"""V4 realtime slice-local Stage-2 geometry/refiner utilities. No world metadata."""
...
LOCAL_FEATURE_COLUMNS=[
    ...
    "touches_xy_edge","edge_distance_vox","partial_pole_candidate"
]
...
def line_local_physical_ok(row,min_horizontal_span_ft=.5,max_verticality=.85,max_vertical_horizontal=2.5,max_tortuosity=4.0):
    ...
    This gate is deliberately loose so short/occluded legitimate wire fragments are not discarded
