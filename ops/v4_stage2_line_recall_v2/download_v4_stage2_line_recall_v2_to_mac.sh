...
LOCAL_ROOT="${LOCAL_ROOT:-$HOME/Downloads/v4_stage2_line_recall_v2}"

REMOTE_ARCHIVE=$(ssh "$SSH_ALIAS" 'cat "$HOME/LATEST_V4_STAGE2_LINE_RECALL_V2_ARCHIVE.txt"')
