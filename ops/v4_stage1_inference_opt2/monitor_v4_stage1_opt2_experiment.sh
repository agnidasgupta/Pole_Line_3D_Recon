#!/usr/bin/env bash
set -u
PID_FILE=/home/agni/LATEST_V4_STAGE1_OPT2_PID.txt
RUN_FILE=/home/agni/LATEST_V4_STAGE1_OPT2_RUN.txt
LAUNCH_FILE=/home/agni/LATEST_V4_STAGE1_OPT2_LAUNCH_LOG.txt
[ -s "$PID_FILE" ] && [ -s "$RUN_FILE" ] || { echo "NO_LATEST_STAGE1_OPT2_POINTERS"; exit 2; }
