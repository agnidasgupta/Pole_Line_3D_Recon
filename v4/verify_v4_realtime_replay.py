#!/usr/bin/env python3
"""Compatibility entry point; implementation: scripts/validation/verify_v4_realtime_replay.py."""
...
_execute(globals(), 'scripts/validation/verify_v4_realtime_replay.py')
