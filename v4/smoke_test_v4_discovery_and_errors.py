#!/usr/bin/env python3
"""Compatibility entry point; implementation: tests/v4/smoke_test_v4_discovery_and_errors.py."""
...
_execute(globals(), 'tests/v4/smoke_test_v4_discovery_and_errors.py')
