...
The subsequent [L40S validation](L40S_VALIDATION.md) passed three fresh-process comparisons for both stages and produced a combined native Nsight capture. No new GPU speedup or H100 execution claim is made. Production assets remain outstanding.
