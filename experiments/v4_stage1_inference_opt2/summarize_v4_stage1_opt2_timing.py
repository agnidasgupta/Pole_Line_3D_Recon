...
def main():
    ...
    lines = [
        ...
        "",
        "Production-equivalence contract: the complete accepted V4 inference path is fixed:",
        "checkpoint/calibration, active_gpu, BF16, batch 12, channels-last, full model heads,",
        "64^3 input patch, 48^3 output core, score fusion, thresholds, and output decisions.",
        "Scores and predicted outputs must reproduce production exactly (score_atol=0).",
        "This is an implementation check, not evaluation against incomplete ground-truth labels.",
