#!/usr/bin/env python3
"""Compatibility entry point; implementation: benchmarks/v4/benchmark_v4_stage1_batch_sizes.py."""
...
_execute(globals(), 'benchmarks/v4/benchmark_v4_stage1_batch_sizes.py')
