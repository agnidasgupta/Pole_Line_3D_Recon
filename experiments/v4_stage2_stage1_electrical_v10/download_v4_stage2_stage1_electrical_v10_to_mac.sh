...
REMOTE_ARCHIVE=$(ssh "$REMOTE" 'cat "$HOME/LATEST_V4_STAGE2_STAGE1_ELECTRICAL_V10_ARCHIVE.txt"')
REMOTE_RUN=$(ssh "$REMOTE" 'cat "$HOME/LATEST_V4_STAGE2_STAGE1_ELECTRICAL_V10_RUN.txt"')
...
echo "V10 STAGE1 ELECTRICAL DOWNLOAD OK"
